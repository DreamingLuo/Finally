...
- (void)viewDidLoad
{
    ...
    self.navigationItem.leftBarButtonItem=[[UIBarButtonItem alloc]initWithImage:[UIImage imageNamed:@"icon3_c_footer@3x.png"] style:UIBarButtonItemStylePlain target:self action:@selector(show)];
